...
let CreateAccountInput = class CreateAccountInput extends graphql_1.PickType(user_entity_1.User, ['email', 'password', 'role'], graphql_1.InputType) {
};
CreateAccountInput = __decorate([
    graphql_1.InputType()
], CreateAccountInput);
exports.CreateAccountInput = CreateAccountInput;
let CreateAccountOutput = class CreateAccountOutput extends core_entity_1.CoreOutput {
};
